...
> ✅ **Maestro Cloud removido (2026-05-19):** `maestro-cloud.yml` migrado para emulador Android gratuito no GitHub Actions — `MAESTRO_API_KEY` não é mais necessário.
...
| `maestro-cloud.yml` | Após `eas.yml` na `main` / manual | E2E via emulador Android no GitHub Actions (gratuito) — migrado em 2026-05-19 |
...
| `MAESTRO_API_KEY` | —                                  | ✅ removido — E2E roda via emulador no GitHub Actions |
